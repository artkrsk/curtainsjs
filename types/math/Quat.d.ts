 ...
 ***/
export class Quat {
    constructor(elements?: Float32Array<ArrayBuffer>, axisOrder?: string);
    type: string;
     ...
     ***/
    setFromArray(this: Quat, array: any): Quat;
    /***
     ...
     ***/
    setAxisOrder(this: Quat, axisOrder: any): Quat;
    /***
     ...
     ***/
    copy(this: Quat, quaternion: any): Quat;
    /***
     Clone a quaternion
     ...
     ***/
    setFromVec3(this: Quat, vector: any): Quat;
}
