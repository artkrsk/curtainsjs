...
export class Mesh {
    constructor(renderer: any, type?: string, { vertexShaderID, fragmentShaderID, vertexShader, fragmentShader, uniforms, widthSegments, heightSegments, renderOrder, depthTest, cullFace, texturesOptions, crossOrigin }?: {
        ...
        texturesOptions?: {} | undefined;
        crossOrigin?: string | undefined;
    });
    type: string;
    renderer: any;
    gl: any;
    _canDraw: boolean | undefined;
    renderOrder: number | undefined;
    _depthTest: boolean | undefined;
    cullFace: string | undefined;
    ...
    _program: Program | undefined;
    uniforms: {} | undefined;
    _initMesh(): void;
    uuid: string | undefined;
    loader: PlaneTextureLoader | undefined;
     ...
     ***/
    loadSources(sourcesArray: any, texturesOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadSource(source: any, textureOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadImage(source: any, textureOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadVideo(source: any, textureOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @successCallback (function): callback to execute on source loading success
     ***/
    loadCanvas(source: any, textureOptions: {} | undefined, successCallback: any): void;
    /*** LOAD ARRAYS ***/
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadImages(imagesArray: any, texturesOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadVideos(videosArray: any, texturesOptions: {} | undefined, successCallback: any, errorCallback: any): void;
    /***
     ...
     @errorCallback (function): callback to execute on source loading error
     ***/
    loadCanvases(canvasesArray: any, texturesOptions: {} | undefined, successCallback: any): void;
    /***
    ...
    /***
     ...
     @this: our plane to handle chaining
     ***/
    onAfterRender(callback: any): this;
