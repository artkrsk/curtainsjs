export class Plane extends DOMMesh {
    constructor(renderer: any, htmlElement: any, { widthSegments, heightSegments, renderOrder, depthTest, cullFace, uniforms, vertexShaderID, fragmentShaderID, vertexShader, fragmentShader, texturesOptions, crossOrigin, alwaysDraw, visible, transparent, drawCheckMargins, autoloadSources, watchScroll, fov, }?: {
        ...
        autoloadSources?: boolean | undefined;
        watchScroll?: boolean | undefined;
        fov?: number | undefined;
    });
    index: any;
    alwaysDraw: boolean | undefined;
    _shouldDraw: boolean | undefined;
    visible: boolean | undefined;
    _transparent: boolean | undefined;
    drawCheckMargins: {
        top: number;
        right: number;
        bottom: number;
    ...
    autoloadSources: boolean | undefined;
    watchScroll: boolean | undefined;
    _updateMVMatrix: boolean | undefined;
    ...
    quaternion: Quat | undefined;
    relativeTranslation: Vec3 | undefined;
    _translation: Vec3 | undefined;
    scale: Vec3 | undefined;
    transformOrigin: Vec3 | undefined;
    /***
     ...
     ***/
    _documentToWorldSpace(vector: any): Vec2;
    /***
     ...
     ***/
    onReEnterView(callback: any): this;
